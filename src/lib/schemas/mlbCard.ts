...
export const MlbCardSchema = z.object({
	uuid: z.string(),
	type: z.string(),
	img: z.string(),
	baked_img: z.string(),
...
export const PublicApiMlbCardSchema = MlbCardSchema.omit({ id: true });

export type MlbCard = z.infer<typeof MlbCardSchema>;
export type PublicApiMlbCard = z.infer<typeof PublicApiMlbCardSchema>;
